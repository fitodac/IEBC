...
Inspired on Image Widget by Modern Tribe, Inc. (http://m.tri.be/26)
Version: 4.2.2
*/
...
class Tribe_Image_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		if ( $this->use_old_uploader() ) {
			require_once( __DIR__ . 'image-widget/ImageWidgetDeprecated.php' );
	...
	public function admin_setup() {
		wp_enqueue_media();
		wp_enqueue_script( 'tribe-image-widget', get_template_directory_uri() . '/inc/widgets/image-widget/image-widget.js', array( 'jquery', 'media-upload', 'media-views' ), self::VERSION );
	...
	public function widget( $args, $instance ) {
      ...
      include __DIR__ . '/image-widget/widget.php';
		}
	}
	...
	public function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, self::get_defaults() );
		if ( $this->use_old_uploader() ) {
      include __DIR__ . '/image-widget/widget-admin.deprecated.php';
    } else {
			include __DIR__ . '/image-widget/widget-admin.php';
		}
	}
